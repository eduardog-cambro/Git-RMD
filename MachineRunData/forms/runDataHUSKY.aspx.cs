...
namespace cambro
{
    public partial class _runDataHUSKY : System.Web.UI.Page
    {
        ...
        private string SaveBarrelTemperatures()
        {
            ...
            results = _database.postBarrelTemperatures(_global.Fld2Int(hBarrelTemperaturesRecId.Value),
                                                        ...
                                                        _global.Fld2Int(txtSHHeat.Text),
                                                        _global.Fld2Int(txtBarrelHead.Text),
        ...
        private string SaveInjectionProfile()
        {
            ...
            results = _database.postInjectionProfile(_global.Fld2Int(hInjectionProfileRecId.Value),
                                                    ...
                                                    0, //_global.Fld2Dbl(txtInjectionPress1.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionPress2.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionPress3.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionPress4.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionPress5.Text),
                                                    0, //_global.Fld2Int(txtInjectionFlow1.Text),
                                                    0, //_global.Fld2Int(txtInjectionFlow2.Text),
                                                    0, //_global.Fld2Int(txtInjectionFlow3.Text),
                                                    0, //_global.Fld2Int(txtInjectionFlow4.Text),
                                                    0, //_global.Fld2Int(txtInjectionFlow5.Text),
                                                    "", //txtTransMode.Text,
                                                    _global.Fld2Dbl(txtTransPosition.Text),
                                                    0, //_global.Fld2Int(txtIPS_PSI.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionPressureThreshold.Text),
                                                    0, //_global.Fld2Int(txtInjectionPositionThreshold.Text),
                                                    0, //_global.Fld2Dbl(txtInjectionTimeThreshold.Text),
                                                    _global.Fld2Int(txtInjectionPressLimit.Text),
                                                    ...
                                                    _global.Fld2Dbl(txtHoldPress1_Seconds.Text),
                                                    _global.Fld2Dbl(txtHoldPress2_Seconds.Text),
                                                    0, //_global.Fld2Int(txtHoldFlow1.Text),
                                                    0, //_global.Fld2Int(txtHoldFlow2.Text),
                                                    0, //_global.Fld2Dbl(txtHoldTime1.Text),
                                                    0, //_global.Fld2Dbl(txtHoldTime2.Text),
        ...
        private void GetInjectionProfile()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtShotSize.Text = _global.Fld2Num(oRow["ShotSize"], 1);
                ...
                txtInjectionChangePos1.Text = _global.Fld2Num(oRow["InjectionChangePos1"], 1);
                txtInjectionChangePos2.Text = _global.Fld2Num(oRow["InjectionChangePos2"], 1);
                txtInjectionChangePos3.Text = _global.Fld2Num(oRow["InjectionChangePos3"], 1);
                txtInjectionChangePos4.Text = _global.Fld2Num(oRow["InjectionChangePos4"], 1);
                //txtInjectionPress1.Text = _global.Fld2Num(oRow["InjectionPress1"], 1);
                //txtInjectionPress2.Text = _global.Fld2Num(oRow["InjectionPress2"], 1);
                //txtInjectionPress3.Text = _global.Fld2Num(oRow["InjectionPress3"], 1);
                //txtInjectionPress4.Text = _global.Fld2Num(oRow["InjectionPress4"], 1);
                //txtInjectionPress5.Text = _global.Fld2Num(oRow["InjectionPress5"], 1);
                ...
                //txtHoldTime1.Text = _global.Fld2Num(oRow["HoldTime1"], 1);
                //txtHoldTime2.Text = _global.Fld2Num(oRow["HoldTime2"], 1);
        ...
        private string SaveRecoveryClampProfile()
        {
            ...
            results = _database.postRecoveryClampProfile(_global.Fld2Int(hRecoveryClampProfileRecId.Value),
                                                        ...
                                                        0, //_global.Fld2Dbl(txtChargePosition2.Text),
                                                        ...
                                                        _global.Fld2Int(txtScrewRecovery1RPM.Text),
                                                        _global.Fld2Int(txtScrewRecovery2RPM.Text),
                                                        _global.Fld2Dbl(txtBackPressure1.Text),
                                                        _global.Fld2Dbl(txtBackPressure2.Text),
                                                        _global.Fld2Dbl(txtPostPullback.Text),
        ...
        private void GetRecoveryClampProfile()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtChargePosition1.Text = _global.Fld2Num(oRow["ChargePosition1"], 1);
        ...
        private string SaveValveGateData()
        {
            ...
            results = _database.postValveGateData(_global.Fld2Int(hValveGateDataRecId.Value),
                                                    ...
                                                    _global.Fld2Dbl(txtPSI_VG4.Text));
        ...
        private void GetValveGateData()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtPSI_VG1.Text = _global.Fld2Num(oRow["PSI_VG1"]);
                ...
                txtPSI_VG2.Text = _global.Fld2Num(oRow["PSI_VG2"]);
                ...
                txtPSI_VG3.Text = _global.Fld2Num(oRow["PSI_VG3"]);
                ...
                txtPSI_VG4.Text = _global.Fld2Num(oRow["PSI_VG4"]);
            }
            oDs.Dispose();
        }
        ...
        private void SetTabOrder()
        {
            ...
            txtOpenPostion_VG1.TabIndex = 125;
            //txtOpenTime_VG1.TabIndex = 126;
            //txtOpenHold_VG1.TabIndex = 127;
            //txtCloseDelay_VG1.TabIndex = 128;
            //txtCloseTime_VG1.TabIndex = 129;
            txtClosePostion_VG1.TabIndex = 130;
            //txtCloseHold_VG1.TabIndex = 131;
            //txtHoldDelay_OnOff_VG1.TabIndex = 132;
            //txtHoldActive_OnOff_VG1.TabIndex = 133;
            //txtAdvCloseTime_VG1.TabIndex = 134;
            //txtInjectionHPEndTime_VG1.TabIndex = 135;
            //txtTransfer_VG1.TabIndex = 136;
            txtPSI_VG1.TabIndex = 137;
            txtOpenDelay_VG1.TabIndex = 138;
            txtOpenPostion_VG2.TabIndex = 139;
            //txtOpenTime_VG2.TabIndex = 140
            //txtOpenHold_VG2.TabIndex = 141;
            //txtCloseDelay_VG2.TabIndex = 142;
            //txtCloseTime_VG2.TabIndex = 143;
            txtClosePostion_VG2.TabIndex = 144;
            //txtCloseHold_VG2.TabIndex = 145;
            //txtHoldDelay_OnOff_VG2.TabIndex = 146;
            //txtHoldActive_OnOff_VG2.TabIndex = 147;
            //txtAdvCloseTime_VG2.TabIndex = 148;
            //txtInjectionHPEndTime_VG2.TabIndex = 149;
            //txtTransfer_VG2.TabIndex = 150;
            txtPSI_VG2.TabIndex = 151;
            txtOpenDelay_VG2.TabIndex = 152;
            txtOpenPostion_VG3.TabIndex = 153;
            //txtOpenTime_VG3.TabIndex = 154;
            //txtOpenHold_VG3.TabIndex = 155;
            //txtCloseDelay_VG3.TabIndex = 156;
            //txtCloseTime_VG3.TabIndex = 157;
            txtClosePostion_VG3.TabIndex = 158;
            //txtCloseHold_VG3.TabIndex = 159;
            //txtHoldDelay_OnOff_VG3.TabIndex = 160;
            //txtHoldActive_OnOff_VG3.TabIndex = 161;
            //txtAdvCloseTime_VG3.TabIndex = 162;
            //txtInjectionHPEndTime_VG3.TabIndex = 163;
            //txtTransfer_VG3.TabIndex = 164;
            txtPSI_VG3.TabIndex = 165;
            txtOpenDelay_VG3.TabIndex = 166;
            txtOpenPostion_VG4.TabIndex = 167;
            //txtOpenTime_VG4.TabIndex = 168;
            //txtOpenHold_VG4.TabIndex = 169;
            //txtCloseDelay_VG4.TabIndex = 170;
            //txtCloseTime_VG4.TabIndex = 171;
            txtClosePostion_VG4.TabIndex = 172;
            //txtCloseHold_VG4.TabIndex = 173;
            //txtHoldDelay_OnOff_VG4.TabIndex = 174;
            //txtHoldActive_OnOff_VG4.TabIndex = 175;
            //txtAdvCloseTime_VG4.TabIndex = 176;
            //txtInjectionHPEndTime_VG4.TabIndex = 177;
            //txtTransfer_VG4.TabIndex = 178;
            txtPSI_VG4.TabIndex = 179;
            txtOpenDelay_VG4.TabIndex = 180;
