...
namespace cambro
{
    public partial class _runDataJSW : System.Web.UI.Page
    {
        ...
        private string SaveBarrelTemperatures()
        {
            ...
            results = _database.postBarrelTemperatures(_global.Fld2Int(hBarrelTemperaturesRecId.Value),
                                                        ...
                                                        0, //_global.Fld2Int(txtBarrelCenter3.Text),
                                                        0, //_global.Fld2Int(txtBarrelCenter4.Text),
                                                        0, //_global.Fld2Int(txtBarrelCenter5.Text),
        ...
        private string SaveInjectionProfile()
        {
            ...
            results = _database.postInjectionProfile(_global.Fld2Int(hInjectionProfileRecId.Value),
                                                    ...
                                                    _global.Fld2Dbl(txtInjectionVelocity1.Text),
                                                    _global.Fld2Dbl(txtInjectionVelocity2.Text),
                                                    _global.Fld2Dbl(txtInjectionVelocity3.Text),
                                                    _global.Fld2Dbl(txtInjectionVelocity4.Text),
                                                    _global.Fld2Dbl(txtInjectionVelocity5.Text),
                                                    ...
                                                    0, //_global.Fld2Int(txtInjectionFlow1.Text),
                                                    0, //__global.Fld2Int(txtInjectionFlow2.Text),
                                                    0, //__global.Fld2Int(txtInjectionFlow3.Text),
                                                    0, //__global.Fld2Int(txtInjectionFlow4.Text),
                                                    0, //__global.Fld2Int(txtInjectionFlow5.Text),
                                                    txtTransMode.Text,
                                                    _global.Fld2Dbl(txtTransPosition.Text),
                                                    _global.Fld2Int(txtIPS_PSI.Text),
                                                    0, //__global.Fld2Dbl(txtInjectionPressureThreshold.Text),
                                                    0, //__global.Fld2Int(txtInjectionPositionThreshold.Text),
                                                    0, //__global.Fld2Dbl(txtInjectionTimeThreshold.Text),
                                                    0, //__global.Fld2Int(txtInjectionPressLimit.Text),
                                                    _global.Fld2Int(txtInjectionPSIAtTransfer.Text),
                                                    _global.Fld2Dbl(txtInjectionTimeAct.Text),
                                                    0, //__global.Fld2Int(txtHoldPress1_PSI.Text),
                                                    0, //__global.Fld2Int(txtHoldPress2_PSI.Text),
                                                    _global.Fld2Int(txtHoldPress1_Percent.Text),
                                                    _global.Fld2Int(txtHoldPress2_Percent.Text),
                                                    0, //__global.Fld2Dbl(txtHoldPress1_Seconds.Text),
                                                    0, //__global.Fld2Dbl(txtHoldPress2_Seconds.Text),
                                                    0, //__global.Fld2Int(txtHoldFlow1.Text),
                                                    0, //__global.Fld2Int(txtHoldFlow2.Text),
                                                    _global.Fld2Dbl(txtHoldTime1.Text),
                                                    _global.Fld2Dbl(txtHoldTime2.Text),
                                                    _global.Fld2Dbl(txtInjectionHoldTime.Text),
                                                    0); //__global.Fld2Dbl(txtFinalCushionMM.Text));
        ...
        private void GetInjectionProfile()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtInjectionVelocity1.Text = _global.Fld2Num(oRow["InjectionVelocity1"], 2);
                txtInjectionVelocity2.Text = _global.Fld2Num(oRow["InjectionVelocity2"], 2);
                txtInjectionVelocity3.Text = _global.Fld2Num(oRow["InjectionVelocity3"], 2);
                txtInjectionVelocity4.Text = _global.Fld2Num(oRow["InjectionVelocity4"], 2);
                txtInjectionVelocity5.Text = _global.Fld2Num(oRow["InjectionVelocity5"], 2);
                ...
                txtInjectionPress1.Text = _global.Fld2Num(oRow["InjectionPress1"], 2);
                txtInjectionPress2.Text = _global.Fld2Num(oRow["InjectionPress2"], 2);
                txtInjectionPress3.Text = _global.Fld2Num(oRow["InjectionPress3"], 2);
                txtInjectionPress4.Text = _global.Fld2Num(oRow["InjectionPress4"], 2);
                txtInjectionPress5.Text = _global.Fld2Num(oRow["InjectionPress5"], 2);
                ...
                txtTransPosition.Text = _global.Fld2Num(oRow["TransPosition"], 2);
                ...
                //txtInjectionPositionThreshold.Text = _global.Fld2Num(oRow["InjectionPositionThreshold"]);
                //txtInjectionTimeThreshold.Text = _global.Fld2Num(oRow["InjectionTimeThreshold"], 1);
                ...
                txtHoldPress1_Percent.Text = _global.Fld2Num(oRow["HoldPress1_Percent"]);
                txtHoldPress2_Percent.Text = _global.Fld2Num(oRow["HoldPress2_Percent"]);
                ...
                //txtFinalCushionMM.Text = _global.Fld2Num(oRow["FinalCushionMM"], 1);
            }
            oDs.Dispose();
        }
        ...
        private string SaveRecoveryClampProfile()
        {
            ...
            results = _database.postRecoveryClampProfile(_global.Fld2Int(hRecoveryClampProfileRecId.Value),
                                                        _global.Fld2Int(hMachineDataHeaderId.Value),
                                                        _global.Fld2Dbl(txtPrePullback.Text),
                                                        _global.Fld2Dbl(txtPrePullbackStroke.Text),
                                                        0, //_global.Fld2Dbl(txtSuckbackBeforePosition.Text),
                                                        0, //_global.Fld2Dbl(txtSuckbackAfterPosition.Text),
                                                        _global.Fld2Dbl(txtScrewStartDelay.Text),
                                                        _global.Fld2Dbl(txtChargePosition1.Text),
                                                        _global.Fld2Dbl(txtChargePosition2.Text),
                                                        0, //_global.Fld2Int(txtChargePressure1.Text),
                                                        0, //_global.Fld2Int(txtChargePressure2.Text),
                                                        0, //_global.Fld2Int(txtChargeFlow1.Text),
                                                        0, //_global.Fld2Int(txtChargeFlow2.Text),
                                                        _global.Fld2Dbl(txtScrewRecovery1Percent.Text),
                                                        _global.Fld2Dbl(txtScrewRecovery2Percent.Text),
                                                        ...
                                                        _global.Fld2Dbl(txtPostPullbackSpeedPercent.Text),
                                                        _global.Fld2Dbl(txtPostPullbackStroke.Text),
                                                        _global.Fld2Dbl(txtScrewPositonAfter.Text),
                                                        _global.Fld2Dbl(txtScrewRecoveryTime.Text),
                                                        0, //_global.Fld2Dbl(txtScrewChargeTime.Text),
                                                        _global.Fld2Dbl(txtCoolingTimeSeconds.Text),
                                                        _global.Fld2Dbl(txtMoldProtectPressure.Text),
                                                        0, //_global.Fld2Int(txtMoldProtectFlow.Text),
                                                        _global.Fld2Dbl(txtMoldProtectTime.Text),
                                                        _global.Fld2Int(txtClampTonnage.Text),
                                                        0, //_global.Fld2Int(txtClampHighPressurePSI.Text),
                                                        0, //_global.Fld2Int(txtClampHighPressureFlow.Text),
                                                        ...
                                                        _global.Fld2Dbl(txtFinalCushion.Text));
        ...
        private void GetRecoveryClampProfile()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtScrewRecovery1Percent.Text = _global.Fld2Num(oRow["ScrewRecovery1Percent"], 2);
                txtScrewRecovery2Percent.Text = _global.Fld2Num(oRow["ScrewRecovery2Percent"], 2);
                ...
                txtBackPressure1.Text = _global.Fld2Num(oRow["BackPressure1"], 2);
                txtBackPressure2.Text = _global.Fld2Num(oRow["BackPressure2"], 2);
                ...
                txtCoolingTimeSeconds.Text = _global.Fld2Num(oRow["CoolingTimeSeconds"], 2);
                txtMoldProtectPressure.Text = _global.Fld2Num(oRow["MoldProtectPressure"], 2);
        ...
        private string SaveValveGateData()
        {
            ...
            results = _database.postValveGateData(_global.Fld2Int(hValveGateDataRecId.Value),
                                                    _global.Fld2Int(hMachineDataHeaderId.Value),
                                                    _global.Fld2Dbl(txtOpenDelay_VG1.Text),
                                                    _global.Fld2Dbl(txtOpenTime_VG1.Text),
                                                    0, //_global.Fld2Dbl(txtOpenPostion_VG1.Text),
                                                    0, //_global.Fld2Dbl(txtOpenHold_VG1.Text),
                                                    _global.Fld2Dbl(txtCloseDelay_VG1.Text),
                                                    _global.Fld2Dbl(txtCloseTime_VG1.Text),
                                                    0, //_global.Fld2Dbl(txtClosePostion_VG1.Text),
                                                    0, //_global.Fld2Dbl(txtCloseHold_VG1.Text),
                                                    0, //_global.Fld2Int(txtHoldDelay_OnOff_VG1.Text),
                                                    0, //_global.Fld2Int(txtHoldActive_OnOff_VG1.Text),
                                                    _global.Fld2Dbl(txtAdvCloseTime_VG1.Text),
                                                    _global.Fld2Dbl(txtInjectionHPEndTime_VG1.Text),
                                                    _global.Fld2Dbl(txtTransfer_VG1.Text),
                                                    0, //_global.Fld2Dbl(txtPSI_VG1.Text),
                                                    _global.Fld2Dbl(txtOpenDelay_VG2.Text),
                                                    _global.Fld2Dbl(txtOpenTime_VG2.Text),
                                                    0, //_global.Fld2Dbl(txtOpenPostion_VG2.Text),
                                                    0, //_global.Fld2Dbl(txtOpenHold_VG2.Text),
                                                    _global.Fld2Dbl(txtCloseDelay_VG2.Text),
                                                    _global.Fld2Dbl(txtCloseTime_VG2.Text),
                                                    0, //_global.Fld2Dbl(txtClosePostion_VG2.Text),
                                                    0, //_global.Fld2Dbl(txtCloseHold_VG2.Text),
                                                    0, //_global.Fld2Int(txtHoldDelay_OnOff_VG2.Text),
                                                    0, //_global.Fld2Int(txtHoldActive_OnOff_VG2.Text),
                                                    _global.Fld2Dbl(txtAdvCloseTime_VG2.Text),
                                                    _global.Fld2Dbl(txtInjectionHPEndTime_VG2.Text),
                                                    _global.Fld2Dbl(txtTransfer_VG2.Text),
                                                    0, //_global.Fld2Dbl(txtPSI_VG2.Text),
                                                    _global.Fld2Dbl(txtOpenDelay_VG3.Text),
                                                    _global.Fld2Dbl(txtOpenTime_VG3.Text),
                                                    0, //_global.Fld2Dbl(txtOpenPostion_VG3.Text),
                                                    0, //_global.Fld2Dbl(txtOpenHold_VG3.Text),
                                                    _global.Fld2Dbl(txtCloseDelay_VG3.Text),
                                                    _global.Fld2Dbl(txtCloseTime_VG3.Text),
                                                    0, //_global.Fld2Dbl(txtClosePostion_VG3.Text),
                                                    0, //_global.Fld2Dbl(txtCloseHold_VG3.Text),
                                                    0, //_global.Fld2Int(txtHoldDelay_OnOff_VG3.Text),
                                                    0, //_global.Fld2Int(txtHoldActive_OnOff_VG3.Text),
                                                    _global.Fld2Dbl(txtAdvCloseTime_VG3.Text),
                                                    _global.Fld2Dbl(txtInjectionHPEndTime_VG3.Text),
                                                    _global.Fld2Dbl(txtTransfer_VG3.Text),
                                                    0, //_global.Fld2Dbl(txtPSI_VG3.Text),
                                                    _global.Fld2Dbl(txtOpenDelay_VG4.Text),
                                                    _global.Fld2Dbl(txtOpenTime_VG4.Text),
                                                    0, //_global.Fld2Dbl(txtOpenPostion_VG4.Text),
                                                    0, //_global.Fld2Dbl(txtOpenHold_VG4.Text),
                                                    _global.Fld2Dbl(txtCloseDelay_VG4.Text),
                                                    _global.Fld2Dbl(txtCloseTime_VG4.Text),
                                                    0, //_global.Fld2Dbl(txtClosePostion_VG4.Text),
                                                    0, //_global.Fld2Dbl(txtCloseHold_VG4.Text),
                                                    0, //_global.Fld2Int(txtHoldDelay_OnOff_VG4.Text),
                                                    0, //_global.Fld2Int(txtHoldActive_OnOff_VG4.Text),
                                                    _global.Fld2Dbl(txtAdvCloseTime_VG4.Text),
                                                    _global.Fld2Dbl(txtInjectionHPEndTime_VG4.Text),
                                                    _global.Fld2Dbl(txtTransfer_VG4.Text)
        ...
        private void GetValveGateData()
        {
            ...
            foreach (DataRow oRow in oDs.Tables[0].Rows)
            {
                ...
                txtOpenDelay_VG1.Text = _global.Fld2Num(oRow["OpenDelay_VG1"], 2);
                txtOpenTime_VG1.Text = _global.Fld2Num(oRow["OpenTime_VG1"], 2);
                //txtOpenPostion_VG1.Text = _global.Fld2Num(oRow["OpenPostion_VG1"], 2);
                //txtOpenHold_VG1.Text = _global.Fld2Num(oRow["OpenHold_VG1"], 2);
                txtCloseDelay_VG1.Text = _global.Fld2Num(oRow["CloseDelay_VG1"], 2);
                txtCloseTime_VG1.Text = _global.Fld2Num(oRow["CloseTime_VG1"], 2);
                //txtClosePostion_VG1.Text = _global.Fld2Num(oRow["ClosePostion_VG1"], 2);
                //txtCloseHold_VG1.Text = _global.Fld2Num(oRow["CloseHold_VG1"], 2);
                //txtHoldDelay_OnOff_VG1.Text = _global.Fld2Num(oRow["HoldDelay_OnOff_VG1"]);
                //txtHoldActive_OnOff_VG1.Text = _global.Fld2Num(oRow["HoldActive_OnOff_VG1"]);
                txtAdvCloseTime_VG1.Text = _global.Fld2Num(oRow["AdvCloseTime_VG1"], 2);
                txtInjectionHPEndTime_VG1.Text = _global.Fld2Num(oRow["InjectionHPEndTime_VG1"], 2);
                txtTransfer_VG1.Text = _global.Fld2Num(oRow["Transfer_VG1"], 2);
                //txtPSI_VG1.Text = _global.Fld2Num(oRow["PSI_VG1"], 2);
                txtOpenDelay_VG2.Text = _global.Fld2Num(oRow["OpenDelay_VG2"], 2);
                txtOpenTime_VG2.Text = _global.Fld2Num(oRow["OpenTime_VG2"], 2);
                //txtOpenPostion_VG2.Text = _global.Fld2Num(oRow["OpenPostion_VG2"], 2);
                //txtOpenHold_VG2.Text = _global.Fld2Num(oRow["OpenHold_VG2"], 2);
                txtCloseDelay_VG2.Text = _global.Fld2Num(oRow["CloseDelay_VG2"], 2);
                txtCloseTime_VG2.Text = _global.Fld2Num(oRow["CloseTime_VG2"], 2);
                //txtClosePostion_VG2.Text = _global.Fld2Num(oRow["ClosePostion_VG2"], 2);
                //txtCloseHold_VG2.Text = _global.Fld2Num(oRow["CloseHold_VG2"], 2);
                //txtHoldDelay_OnOff_VG2.Text = _global.Fld2Num(oRow["HoldDelay_OnOff_VG2"]);
                //txtHoldActive_OnOff_VG2.Text = _global.Fld2Num(oRow["HoldActive_OnOff_VG2"]);
                txtAdvCloseTime_VG2.Text = _global.Fld2Num(oRow["AdvCloseTime_VG2"], 2);
                txtInjectionHPEndTime_VG2.Text = _global.Fld2Num(oRow["InjectionHPEndTime_VG2"], 2);
                txtTransfer_VG2.Text = _global.Fld2Num(oRow["Transfer_VG2"], 2);
                //txtPSI_VG2.Text = _global.Fld2Num(oRow["PSI_VG2"], 2);
                txtOpenDelay_VG3.Text = _global.Fld2Num(oRow["OpenDelay_VG3"], 2);
                txtOpenTime_VG3.Text = _global.Fld2Num(oRow["OpenTime_VG3"], 2);
                //txtOpenPostion_VG3.Text = _global.Fld2Num(oRow["OpenPostion_VG3"], 2);
                //txtOpenHold_VG3.Text = _global.Fld2Num(oRow["OpenHold_VG3"], 2);
                txtCloseDelay_VG3.Text = _global.Fld2Num(oRow["CloseDelay_VG3"], 2);
                txtCloseTime_VG3.Text = _global.Fld2Num(oRow["CloseTime_VG3"], 2);
                //txtClosePostion_VG3.Text = _global.Fld2Num(oRow["ClosePostion_VG3"], 2);
                //txtCloseHold_VG3.Text = _global.Fld2Num(oRow["CloseHold_VG3"], 2);
                //txtHoldDelay_OnOff_VG3.Text = _global.Fld2Num(oRow["HoldDelay_OnOff_VG3"]);
                //txtHoldActive_OnOff_VG3.Text = _global.Fld2Num(oRow["HoldActive_OnOff_VG3"]);
                txtAdvCloseTime_VG3.Text = _global.Fld2Num(oRow["AdvCloseTime_VG3"], 2);
                txtInjectionHPEndTime_VG3.Text = _global.Fld2Num(oRow["InjectionHPEndTime_VG3"], 2);
                txtTransfer_VG3.Text = _global.Fld2Num(oRow["Transfer_VG3"], 2);
                //txtPSI_VG3.Text = _global.Fld2Num(oRow["PSI_VG3"], 2);
                txtOpenDelay_VG4.Text = _global.Fld2Num(oRow["OpenDelay_VG4"], 2);
                txtOpenTime_VG4.Text = _global.Fld2Num(oRow["OpenTime_VG4"], 2);
                //txtOpenPostion_VG4.Text = _global.Fld2Num(oRow["OpenPostion_VG4"], 2);
                //txtOpenHold_VG4.Text = _global.Fld2Num(oRow["OpenHold_VG4"], 2);
                txtCloseDelay_VG4.Text = _global.Fld2Num(oRow["CloseDelay_VG4"], 2);
                txtCloseTime_VG4.Text = _global.Fld2Num(oRow["CloseTime_VG4"], 2);
                //txtClosePostion_VG4.Text = _global.Fld2Num(oRow["ClosePostion_VG4"], 2);
                //txtCloseHold_VG4.Text = _global.Fld2Num(oRow["CloseHold_VG4"], 2);
                //txtHoldDelay_OnOff_VG4.Text = _global.Fld2Num(oRow["HoldDelay_OnOff_VG4"]);
                //txtHoldActive_OnOff_VG4.Text = _global.Fld2Num(oRow["HoldActive_OnOff_VG4"]);
                txtAdvCloseTime_VG4.Text = _global.Fld2Num(oRow["AdvCloseTime_VG4"], 2);
                txtInjectionHPEndTime_VG4.Text = _global.Fld2Num(oRow["InjectionHPEndTime_VG4"], 2);
                txtTransfer_VG4.Text = _global.Fld2Num(oRow["Transfer_VG4"], 2);
                //txtPSI_VG4.Text = _global.Fld2Num(oRow["PSI_VG4"], 2);
            }
            oDs.Dispose();
        }
        ...
        private void SetTabOrder()
        {
            ...
            txtAdvCloseTime_VG1.TabIndex = 129;
            txtCloseDelay_VG1.TabIndex = 130;
            txtCloseTime_VG1.TabIndex = 131;
            //txtClosePostion_VG1.TabIndex = 132;
            //txtCloseHold_VG1.TabIndex = 133;
            //txtHoldDelay_OnOff_VG1.TabIndex = 134;
            //txtHoldActive_OnOff_VG1.TabIndex = 135;
            ...
            txtAdvCloseTime_VG2.TabIndex = 143;
            txtCloseDelay_VG2.TabIndex = 144;
            txtCloseTime_VG2.TabIndex = 145;
            //txtClosePostion_VG2.TabIndex = 146;
            //txtCloseHold_VG2.TabIndex = 147;
            //txtHoldDelay_OnOff_VG2.TabIndex = 148;
            //txtHoldActive_OnOff_VG2.TabIndex = 149;
            ...
            txtAdvCloseTime_VG3.TabIndex = 157;
            txtCloseDelay_VG3.TabIndex = 158;
            txtCloseTime_VG3.TabIndex = 159;
            //txtClosePostion_VG3.TabIndex = 160;
            //txtCloseHold_VG3.TabIndex = 161;
            //txtHoldDelay_OnOff_VG3.TabIndex = 162;
            //txtHoldActive_OnOff_VG3.TabIndex = 163;
            ...
            txtAdvCloseTime_VG4.TabIndex = 171;
            txtCloseDelay_VG4.TabIndex = 172;
            txtCloseTime_VG4.TabIndex = 173;
            //txtClosePostion_VG4.TabIndex = 174;
            //txtCloseHold_VG4.TabIndex = 175;
            //txtHoldDelay_OnOff_VG4.TabIndex = 176;
            //txtHoldActive_OnOff_VG4.TabIndex = 177;
            txtInjectionHPEndTime_VG4.TabIndex = 178;
            txtTransfer_VG4.TabIndex = 179;
            //txtPSI_VG4.TabIndex = 180;
            txtShotSize.TabIndex = 181;
            txtInjectionPress1.TabIndex = 182;
            txtInjectionPress2.TabIndex = 183;
            txtInjectionPress3.TabIndex = 184;
            txtInjectionPress4.TabIndex = 185;
            txtInjectionPress5.TabIndex = 186;
            txtInjectionVelocity1.TabIndex = 187;
            txtInjectionVelocity2.TabIndex = 188;
            txtInjectionVelocity3.TabIndex = 189;
            txtInjectionVelocity4.TabIndex = 190;
            txtInjectionVelocity5.TabIndex = 191;
            txtInjectionChangePos1.TabIndex = 192;
            txtInjectionChangePos2.TabIndex = 193;
            txtInjectionChangePos3.TabIndex = 194;
            txtInjectionChangePos4.TabIndex = 195;
            ...
            //txtInjectionPressureThreshold.TabIndex = 204;
            //txtInjectionPositionThreshold.TabIndex = 205;
            ...
            //txtSuckbackAfterPosition.TabIndex = 225;
            txtScrewStartDelay.TabIndex = 226;
            txtChargePosition1.TabIndex = 227;
            txtChargePosition2.TabIndex = 228;
            //txtChargePressure1.TabIndex = 229;
            //txtChargePressure2.TabIndex = 230;
            //txtChargeFlow1.TabIndex = 231;
            //txtChargeFlow2.TabIndex = 232;
            txtScrewRecovery1Percent.TabIndex = 233;
            txtScrewRecovery2Percent.TabIndex = 234;
            //txtScrewRecovery1RPM.TabIndex = 235;
            //txtScrewRecovery2RPM.TabIndex = 236;
            txtBackPressure1.TabIndex = 237;
            txtBackPressure2.TabIndex = 238;
        ...
        private void SecureForm(int action, string status)
        {
            if (action == runSheetActions.IsView)
            {
                ...
                // Machine Run Administrator can edit run comments
